...
* Engineered new categorical variables to isolate weekday vs. weekend performance patterns.

### 2. Exploratory Data Analysis (EDA)
* Plotted statistical distributions of order preparation and delivery transit times across varying fulfillment windows.
* Conducted correlation analyses between order volume metrics and restaurant operational processing speeds.

### 3. Delivery Performance Diagnostics
